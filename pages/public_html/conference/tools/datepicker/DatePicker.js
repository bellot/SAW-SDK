...
function getAnchorPosition(anchorname) {
  ...
  coordinates.x = AnchorPosition_getPageOffsetLeft(anchor) ;
  coordinates.y = AnchorPosition_getPageOffsetTop(anchor) ;
...
function AnchorPosition_getPageOffsetLeft (el) {
  ...
  while ((el=el.offsetParent && el.style.position != "absolute") != null) { 
    ol += el.offsetLeft; 
  }
