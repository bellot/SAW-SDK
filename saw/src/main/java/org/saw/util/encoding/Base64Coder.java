 ...
 * the <a href="http://www.gnu.org/licenses/lgpl.html">GNU/LGPL</a> license.<br>
 ...
 * <p>
 * Version history:<br>
 * 2011-03-14 Patrick Bellot: personal customization of the interface.<br>
...
public final class Base64Coder {
    ...
    {
	return new String(bytesToChars(in)) ;
    }


    public static char[] bytesToChars(byte[] in) 
    {
	return bytesToChars(in,in.length); 
    }

    private static char[] bytesToChars(byte[] in, int iLen) 
    {
    ...
    {
	return charsToBytes(in.toCharArray()) ;
    }
